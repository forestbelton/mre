...
; CopyBgMap descriptor below. Assembled from assets/tempest_portrait/ via
...
TempestPortraitTiles:
	INCBIN "assets/tempest_portrait/tiles.bin"
...
TempestPortraitIndexMap:
	INCBIN "assets/tempest_portrait/tilemap.bin"

SECTION "TempestPortraitAttrMap", ROMX[$7549], BANK[$1e]
TempestPortraitAttrMap:
	INCBIN "assets/tempest_portrait/attrmap.bin"
