...
.spawners
    dstruct Spawner, , .X=2, .Y=1, .P0=$00, .P1=$02, .P2=$01, .Index=0
    dstruct Spawner, , .X=0, .Y=255, .P0=$ff, .P1=$ff, .P2=$ff, .Index=255
    dstruct Spawner, , .X=8, .Y=1, .P0=$00, .P1=$02, .P2=$01, .Index=0
    dstruct Spawner, , .X=0, .Y=255, .P0=$ff, .P1=$ff, .P2=$ff, .Index=255
    EMPTY_SPAWNER_SLOT
    EMPTY_SPAWNER_SLOT
    EMPTY_SPAWNER_SLOT
