...
.spawners
    dstruct Spawner, , .X=8, .Y=7, .P0=$00, .P1=$02, .P2=$02, .Index=1
    EMPTY_SPAWNER_SLOT
    dstruct Spawner, , .X=6, .Y=5, .P0=$00, .P1=$02, .P2=$03, .Index=1
    EMPTY_SPAWNER_SLOT
    dstruct Spawner, , .X=4, .Y=3, .P0=$00, .P1=$02, .P2=$04, .Index=2
    EMPTY_SPAWNER_SLOT
    dstruct Spawner, , .X=2, .Y=1, .P0=$00, .P1=$02, .P2=$04, .Index=2
    EMPTY_SPAWNER_SLOT
