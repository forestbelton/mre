...
.spawners
    dstruct Spawner, , .X=2, .Y=1, .P0=$00, .P1=$02, .P2=$03, .Index=0
    EMPTY_SPAWNER_SLOT
    dstruct Spawner, , .X=4, .Y=1, .P0=$00, .P1=$02, .P2=$03, .Index=0
    EMPTY_SPAWNER_SLOT
    dstruct Spawner, , .X=6, .Y=1, .P0=$00, .P1=$02, .P2=$03, .Index=0
    EMPTY_SPAWNER_SLOT
    dstruct Spawner, , .X=8, .Y=1, .P0=$00, .P1=$00, .P2=$03, .Index=0
    EMPTY_SPAWNER_SLOT
