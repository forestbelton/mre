...
Room41:
    dstruct Header, , .Id=$54, .SpawnX=1, .SpawnY=7, .Pad=$00, .Tileset=$00, .Palette=$05, .Height=10, .Width=11
...
.monsters
    dstruct Monster, , .X=5, .Y=4, .Type=$22, .Facing=$00, .Index=1   ; FLAME_BLUE
    dstruct Monster, , .X=3, .Y=5, .Type=$22, .Facing=$00, .Index=1   ; FLAME_BLUE
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
