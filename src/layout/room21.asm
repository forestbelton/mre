...
Room21:
    dstruct Header, , .Id=$3d, .SpawnX=1, .SpawnY=1, .Pad=$00, .Tileset=$04, .Palette=$03, .Height=10, .Width=11
...
.monsters
    dstruct Monster, , .X=8, .Y=5, .Type=$22, .Facing=$00, .Index=1   ; JELL
    dstruct Monster, , .X=8, .Y=3, .Type=$22, .Facing=$00, .Index=1   ; JELL
    dstruct Monster, , .X=8, .Y=1, .Type=$22, .Facing=$00, .Index=1   ; JELL
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
