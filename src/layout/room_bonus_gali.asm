...
SECTION "Gali room", ROMX

RoomBonusGali:
    dstruct Header, , .Id=$67, .SpawnX=1, .SpawnY=7, .Pad=$00, .Tileset=$00, .Palette=$00, .Height=10, .Width=11
...
.monsters
    dstruct Monster, , .X=5, .Y=5, .Type=$22, .Facing=$00, .Index=3
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
