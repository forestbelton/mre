...
Room03:
    dstruct Header, , .Id=$0a, .SpawnX=1, .SpawnY=8, .Pad=$00, .Tileset=$00, .Palette=$00, .Height=10, .Width=11
...
.monsters
    dstruct Monster, , .X=2, .Y=4, .Type=$21, .Facing=$02, .Index=0   ; GHOST
    dstruct Monster, , .X=5, .Y=5, .Type=$21, .Facing=$03, .Index=0   ; GHOST
    dstruct Monster, , .X=7, .Y=4, .Type=$21, .Facing=$02, .Index=0   ; GHOST
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
