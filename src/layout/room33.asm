...
Room33:
    dstruct Header, , .Id=$26, .SpawnX=5, .SpawnY=7, .Pad=$00, .Tileset=$01, .Palette=$04, .Height=10, .Width=11
...
.monsters
    dstruct Monster, , .X=4, .Y=6, .Type=$22, .Facing=$00, .Index=0   ; JOKER
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    dstruct Monster, , .X=6, .Y=6, .Type=$22, .Facing=$01, .Index=0   ; JOKER
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
