; Floor 6 (record 5) -- 11 wide x 10 tall. Tower floor data; see docs/floor_data.md.

INCLUDE "room.inc"

SECTION "room06", ROMX[$4b59], BANK[$2d]
Room06:
    dstruct Header, , .Id=$34, .SpawnX=6, .SpawnY=7, .Pad=$00, .Tileset=$00, .Palette=$00, .Height=10, .Width=11
    assert @ - Room06 == sizeof_Header
    ...
    db COLL_B, COLL_C, COLL_W, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_W, COLL_C, COLL_B
    ...
    db COLL_B, COLL_B, COLL_B, COLL_B, COLL_B, COLL_B, COLL_B, COLL_B, COLL_B, COLL_B, COLL_B
    db COLL_B, COLL_F, COLL_F, COLL_F, ITEM_FLAG | ITEM_RED_CRYSTAL, COLL_F, ITEM_FLAG | ITEM_RED_CRYSTAL, COLL_F, COLL_F, COLL_F, COLL_B
    db COLL_B, COLL_F, COLL_F, COLL_F, COLL_F, ITEM_FLAG | ITEM_MONSTER_FLAME, COLL_F, COLL_F, COLL_F, COLL_F, COLL_B
    db COLL_B, COLL_F, COLL_F, COLL_F, COLL_F, ITEM_FLAG | ITEM_OPEN | ITEM_RED_DIAMOND, COLL_F, COLL_F, COLL_F, COLL_F, COLL_B
    db COLL_B, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_B
    db COLL_B, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_B
    db COLL_B, ITEM_FLAG | ITEM_OPEN | ITEM_GOLD_KEY, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, COLL_F, ITEM_FLAG | ITEM_OPEN | ITEM_BELL, COLL_B
    ...
    db MONSTER_TACOPI, MONSTER_JELL, MONSTER_DINO, MONSTER_TIGER

    ; arr2: 9 monster slots (Monster: X,Y,Type,Param,Index)
.monsters
    dstruct Monster, , .X=8, .Y=3, .Type=$22, .Facing=$00, .Index=1   ; JELL
    dstruct Monster, , .X=2, .Y=3, .Type=$22, .Facing=$00, .Index=1   ; JELL
    dstruct Monster, , .X=3, .Y=2, .Type=$22, .Facing=$00, .Index=2   ; DINO
    dstruct Monster, , .X=7, .Y=2, .Type=$22, .Facing=$00, .Index=2   ; DINO
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
