...
Room06:
    dstruct Header, , .Type=$34, .SpawnX=6, .SpawnY=7, .Pad=$00, .Param0=$00, .Param1=$00, .Height=10, .Width=11
...
.monsters
    ...
    dstruct Monster, , .X=2, .Y=3, .Type=$22, .Param=$00, .Index=1   ; JELL
    dstruct Monster, , .X=3, .Y=2, .Type=$22, .Param=$00, .Index=2   ; DINO
    dstruct Monster, , .X=7, .Y=2, .Type=$22, .Param=$00, .Index=2   ; DINO
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
    EMPTY_MONSTER_SLOT
