...
MistralPortraitTilesBank0:
	INCBIN "assets/portrait/npc/mistral/tiles2.bin"   ; 128 tiles -> VRAM bank 0 $9000

MistralPortraitTiles:
	INCBIN "assets/portrait/npc/mistral/tiles.bin"    ; 384 tiles -> VRAM bank 1 $8000

MistralPortraitPaletteBg:
	INCBIN "assets/portrait/npc/mistral/palette_bg.bin"   ; 6 BG palettes (RGB555 LE)
...
MistralPortraitPaletteObj:
	INCBIN "assets/portrait/npc/mistral/palette_obj.bin"  ; 6 OBJ palettes (RGB555 LE)
...
MistralPortraitIndexMap:
	INCBIN "assets/portrait/npc/mistral/tilemap.bin"  ; 20x11 tile indices

MistralPortraitAttrMap:
	INCBIN "assets/portrait/npc/mistral/attrmap.bin"  ; 20x11 CGB BG attributes (bit 3 = VRAM bank)
...
SECTION "analyzed_0d623e", ROMX[$623e], BANK[$35]
	...
	INCLUDE "assets/portrait/npc/mistral/sprites.asm"
