...
NadaIntroTilesBank0:
	INCBIN "assets/portrait/npc/nada_intro/tiles2.bin"   ; 384 tiles -> VRAM bank 0 $8000

NadaIntroTiles:
	INCBIN "assets/portrait/npc/nada_intro/tiles.bin"    ; 384 tiles -> VRAM bank 1 $8000

NadaIntroPaletteBg:
	INCBIN "assets/portrait/npc/nada_intro/palette_bg.bin"   ; 6 BG palettes (RGB555 LE)

Data_1c_7030:
	db $ff, $7f, $3e, $1b, $37, $01, $4b, $00, $ff, $7f, $94, $52, $4a, $29, $00, $00

NadaIntroPaletteObj:
	INCBIN "assets/portrait/npc/nada_intro/palette_obj.bin"  ; 6 OBJ palettes (RGB555 LE)
...
NadaIntroIndexMap:
	INCBIN "assets/portrait/npc/nada_intro/tilemap.bin"  ; 20x11 tile indices

NadaIntroAttrMap:
	INCBIN "assets/portrait/npc/nada_intro/attrmap.bin"  ; 20x11 CGB BG attributes (bit 3 = VRAM bank)
...
; draws). Layered PNG source in assets/portrait/nada_intro/sprites/ (docs/portrait_overlays.md).
	INCLUDE "assets/portrait/npc/nada_intro/sprites.asm"   ; Nada_<role> blocks
...
NadaScene2Tiles:
	INCBIN "assets/portrait/npc/nada_scene2/tiles.bin"     ; 384 tiles -> VRAM bank 1 $8000
...
NadaScene2IndexMap:
	INCBIN "assets/portrait/npc/nada_scene2/tilemap.bin"   ; 20x11 tile indices

NadaScene2AttrMap:
	INCBIN "assets/portrait/npc/nada_scene2/attrmap.bin"   ; 20x11 CGB BG attributes (bit 3 = VRAM bank)
