...
ASSET ToamunaPortraitPaletteBg, "assets/toamuna/palette_bg.bin" ; 6 BG palettes (RGB555 LE)

DS $10

ASSET ToamunaPortraitPaletteObj, "assets/toamuna/palette_obj.bin" ; 6 OBJ palettes (RGB555 LE)
...
ToamunaPortraitIndexMap: INCBIN "assets/toamuna/tilemap.bin"
ToamunaPortraitAttrMap:  INCBIN "assets/toamuna/attrmap.bin"
...
INCLUDE "assets/toamuna/sprites.asm"   ; Toamuna_face / _hair / _alt_face / _alt_hair
