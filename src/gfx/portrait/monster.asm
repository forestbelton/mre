...
MonsterPortraitTiles_Tiger:
	INCBIN "assets/portrait/monster/tiger/tiles.bin"
MonsterPortraitTiles_Mocchi:
	INCBIN "assets/portrait/monster/mocchi/tiles.bin"
MonsterPortraitTiles_Hare:
	INCBIN "assets/portrait/monster/hare/tiles.bin"
MonsterPortraitTiles_Gali:
	INCBIN "assets/portrait/monster/gali/tiles.bin"
MonsterPortraitTiles_Golem:
	INCBIN "assets/portrait/monster/golem/tiles.bin"
MonsterPortraitTiles_Suezo:
	INCBIN "assets/portrait/monster/suezo/tiles.bin"
MonsterPortraitTiles_Phoenix:
	INCBIN "assets/portrait/monster/phoenix/tiles.bin"
