...
VerdePortraitTiles:                              ; $5c5d, 384 tiles -> VRAM bank 1 $8000
	INCBIN "assets/verde/tiles.bin"

VerdePortraitPaletteBg:                          ; $745d
	INCBIN "assets/verde/palette_bg.bin"     ; 6 BG palettes (RGB555 LE)

	DS $10

VerdePortraitPaletteObj:                         ; $749d
	INCBIN "assets/verde/palette_obj.bin"    ; 6 OBJ palettes (RGB555 LE)
...
VerdePortraitIndexMap:                           ; $74e3
	INCBIN "assets/verde/tilemap.bin"

VerdePortraitAttrMap:                            ; $75bf
	INCBIN "assets/verde/attrmap.bin"
...
VerdeIntroPaletteObj:                            ; $78ce, intro-scene OBJ palettes
	INCBIN "assets/verde/palette_obj2.bin"
