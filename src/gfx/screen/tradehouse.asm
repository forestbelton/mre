...
TradehouseStudioTiles:           ; studio set -> VRAM bank 1 $8000
	INCBIN "assets/tradehouse_studio/tiles.bin"
TradehouseNoteTiles:             ; note-scene set -> VRAM bank 1 $8000
	INCBIN "assets/tradehouse_note/tiles.bin"

TradehousePalettesBg:            ; $7000: 6 BG palettes -> wBgPalettes
	INCBIN "assets/tradehouse_studio/palette_bg.bin"
...
TradehousePalettesObj:           ; $7040: 6 OBJ palettes -> wObjPalettes
	INCBIN "assets/tradehouse_studio/palette_obj.bin"
...
TradehouseStudioMap:             ; CopyBgMap 11x20 -> $9800 (the studio screen)
	...
	dw .idx
.idx:
	INCBIN "assets/tradehouse_studio/tilemap.bin"
.attr:
	INCBIN "assets/tradehouse_studio/attrmap.bin"
...
TradehouseNoteMap:               ; CopyBgMap 11x20 -> $9800 (the note scene)
	...
	dw .idx
.idx:
	INCBIN "assets/tradehouse_note/tilemap.bin"
.attr:
	INCBIN "assets/tradehouse_note/attrmap.bin"
