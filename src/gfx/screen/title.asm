...
; assets/title_screen/title_screen.png by tools/pngasset.py (screen mode, via assets.yaml): both
...
TitleTilesBank0:
	INCBIN "assets/title_screen/tiles_bank0.bin"   ; 384 tiles -> VRAM bank 0 $8000

SECTION "TitleTiles bank1", ROMX[$5800], BANK[$28]
TitleTilesBank1:
	INCBIN "assets/title_screen/tiles_bank1.bin"   ; 384 tiles -> VRAM bank 1 $8000

SECTION "TitlePalettes", ROMX[$7000], BANK[$28]
TitlePalettes:
	INCBIN "assets/title_screen/palette.bin"       ; 8 BG + 8 OBJ palettes (RGB555 LE)
...
TitleIdxMap:
	INCBIN "assets/title_screen/tilemap.bin"

SECTION "TitleAttrMap", ROMX[$71ee], BANK[$28]
TitleAttrMap:
	INCBIN "assets/title_screen/attrmap.bin"
