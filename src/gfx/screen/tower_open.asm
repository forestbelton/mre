...
; assets/tower_entrance_open/tower_entrance_open.png by tools/pngasset.py (screen mode, via assets.yaml): both
...
TowerOpenTilesBank0:
	INCBIN "assets/tower_entrance_open/tiles_bank0.bin"   ; 384 tiles -> VRAM bank 0 $8000

SECTION "TowerOpenTiles bank1", ROMX[$5800], BANK[$26]
TowerOpenTilesBank1:
	INCBIN "assets/tower_entrance_open/tiles_bank1.bin"   ; 384 tiles -> VRAM bank 1 $8000

SECTION "TowerOpenPalettes", ROMX[$7000], BANK[$26]
TowerOpenPalettes:
	INCBIN "assets/tower_entrance_open/palette.bin"       ; 8 BG + 8 OBJ palettes (RGB555 LE)
...
TowerOpenIdxMap:
	INCBIN "assets/tower_entrance_open/tilemap.bin"

SECTION "TowerOpenAttrMap", ROMX[$71ee], BANK[$26]
TowerOpenAttrMap:
	INCBIN "assets/tower_entrance_open/attrmap.bin"
