...
MONSTER_NAME_POINTERS:
	dw MONSTER_NAME_TIGER
	dw MONSTER_NAME_MOCCHI
	dw MONSTER_NAME_HARE
	dw MONSTER_NAME_GALI
	dw MONSTER_NAME_GOLEM
	dw MONSTER_NAME_SUEZO
	dw MONSTER_NAME_PHENIX
...
MONSTER_NAME_PHENIX: db "Phenix", 0
