; Sound id $37 (BGM) -- Tecmo logo jingle
; Bank $3e, ROM $646a-$664c. Auto-generated by tools/songdisasm.py --split; INCLUDEd by sound/bank_3e.asm into its $4b00 section.
